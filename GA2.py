...
# إعدادات الصفحة مع العنوان الجديد
st.set_page_config(page_title="نظام الفلترة لشركة الحياة للتطوير والتنمية العقارية", layout="wide")

# إضافة اللوجو الجديد
st.image("logo.png", width=200)
st.title("نظام الفلترة لشركة الحياة للتطوير والتنمية العقارية")
